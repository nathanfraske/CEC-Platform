#!/usr/bin/env python3
# One-shot splice: PCIe 8-pin 3-port USB-ingress TPS2121 mux (spec v1.6.0 Sec
...
ROOT_DIR = os.path.join(HERE, "..", "beta", "pcie-8pin-3port")
...
ROOT_UUID = "a8ecf94e-f41a-4523-8cf1-1d72f47f3e7e"
...
if __name__ == "__main__":
    ...
    print("PCIe 3-port USB-ingress splice complete.")
