...
#   python3 scripts/cec_channel_route.py --lay-only --board-pcb IN --board modules/eps-8pin --out LANES.kicad_pcb
#   python3 scripts/cec_channel_route.py --route    --board-pcb IN --board modules/eps-8pin --out ROUTED.kicad_pcb
import argparse
import json
import os
import sys
