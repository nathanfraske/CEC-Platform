...
- [ ] [added 2026-06-14 04:50] Corridor-aware reseed placer **Phase 1** (ceiling-breaking): stamp shunt rot270 + build model in synth_one, seed-nudge sense ICs to their own lane channel, add `corridor_cross` to Candidate + the sort key, hard-reject `corridor_cross>0` in proxy_reject. Validate: winning eps candidate has corridor_cross==0.
