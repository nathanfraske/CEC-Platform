...
- [ ] [added 2026-06-14 06:55 · in progress] **Audit the remediated Phase 0/1a + Phase 2** (workflow, on the COMMITTED tree 89266ab so a git-checkout can't lose work). Triage + verify + fix confirmed findings.
