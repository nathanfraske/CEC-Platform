...
- [ ] [added 2026-06-13 23:25] Await DeepSeek new-impl audit → consolidate the Opus-4.8 + DeepSeek verdict + polish-fix list
- [ ] [added 2026-06-13 23:25] Apply new-impl polish fixes to the prompt-audit PRs (M1 corridor fallback+log; in_family_only header count; progress-lens current-round double-count; _coerce_audit/EI-07 anchor-count check)
