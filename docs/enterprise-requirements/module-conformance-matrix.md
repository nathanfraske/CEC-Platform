...
3. **OQ-5 (RS-485 topology)** sizes the enterprise Hub's streaming guarantee (how many
   concurrent Pro streams); it must close before REQ-HUB-COMMON-043 leaves DRAFT.
