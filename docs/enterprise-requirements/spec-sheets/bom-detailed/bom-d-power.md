...
Correction recorded 2026-08-02: the 2026-07-02 CP2-to-IN2 correction was wrong for the stated fixed-priority requirement. TI defines CP2 low as fixed IN1 priority. CP2 tied to IN2 selects the external-comparator mode instead. The authoritative BETA Hub now has CP2 tied to GND on U5, U7, and U11, and the exported netlist proves the intended MAIN_5V > 5VSB > USB > KVM chain. The older statement about a shipping board was not verified in this audit and must not be used as a production wiring requirement.
