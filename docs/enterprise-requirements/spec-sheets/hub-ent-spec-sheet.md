...
| Storage | QSPI NOR (A/B app slots + rollback-resistant tamper log region, page-program-only on the persist path); external DDR **TBD** (LIM/fabric-SRAM may suffice — firmware confirm) | REQ-062/070; survey 1/4 |
...
| 1 | QSPI NOR 128–256 Mb (W25Q-class) | A/B firmware + tamper-log region | $0.5–1 | survey 1/6 |
