...
| REQ-HPWR-COMMON-002 | The enterprise sensing tier SHALL be the Pro (LTC2358-18 simultaneous 18-bit, ~900 kB/s streaming, CAN control) with the consumer Pro's RS-485 leg and 4.7 kΩ DETECT replaced by 100BASE-T1 and the 10 kΩ class on the ENT build (REQ-MOD-COMMON-003 — the P4 MAC serves it); the Pro board SHALL graduate out of DRAFT (ERC/DRC-clean) before enterprise requirements ratification references it as baseline. | spec §6.1; REQ-MOD-COMMON-003; 12vhpwr-pro README | I+T | — |
