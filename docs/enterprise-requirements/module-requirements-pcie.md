...
| REQ-PCIE-COMMON-002 | The enterprise sensing tier SHALL be PCIe Pro per §6.13 (fast ADC) with the §6.13 RS-485 streaming leg replaced by 100BASE-T1 on the ENT build (REQ-MOD-COMMON-003; RS-485 remains the consumer Pro definition); PCIe Max (spectral, possibly sharing the 12VHPWR Max FPGA data plane) stays PROPOSED behind OQ-59. | spec §6.13; REQ-MOD-COMMON-003; OQ-58/59 | I | OQ-58 |
