# Agent handoff — 2026-06-14 02:50:08Z
...
HEAD:    c11ca31 prompt-audit: vendor the Opus-4.8 new-impl panel report (provenance the polish commits cite)
status:  190 uncommitted path(s)
```
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 726}, "cec-manager-fast": {"since": 1781405121, "active": 0, "idle_s": 271}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 21, "idle_stop_s": 1800.0, "stats": {"requests": 641, "starts": 12, "evictions": 5, "by_client": {"fs-warm": 103, "CEC-Platform": 419, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3}}}
