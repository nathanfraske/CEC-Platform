# Agent handoff — 2026-06-13 22:30:03Z
...
HEAD:    ae0c674 prompt-audit merge-audit follow-ups: H2 wire CI + M1 corridor + M3/M4/M5 coverage
status:  176 uncommitted path(s)
```

### Recent commits
```
ae0c674 prompt-audit merge-audit follow-ups: H2 wire CI + M1 corridor + M3/M4/M5 coverage
5859db8 prompt-audit medium fix: slash-tolerant net membership in the T1 unknown-net guard
3af8bc6 prompt-audit P4 fix: lead the spec-charter excerpt with the locked-decision spine (was truncated off)
e735de5 prompt-audit: ground the T1 intent seat + fix EI-02 lane/corpus/fence (the U5 class)
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 3378}, "cec-worker-vision": {"since": 1781388984, "active": 0, "idle_s": 63}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 23, "idle_stop_s": 1800.0, "stats": {"requests": 563, "starts": 6, "evictions": 1, "by_client": {"fs-warm": 100, "CEC-Platform": 418, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 4}}}
