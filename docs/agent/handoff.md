# Agent handoff — 2026-07-07 19:13:37Z
...
HEAD:    786b5955 Merge remote-tracking branch 'origin/main' into claude/schematic-work-continue-59pw41
...
c7c3ba3d FOLLOWUPS: 12V-2x6 model vendored (verify alignment); 3D sweep closed
9e18c42a Vendor Molex 12V-2x6 (2191161161) 3D model onto CEC_12V2x6_Horizontal
4be7d4e8 FOLLOWUPS: TPS2121 model rotation verify + Molex 12V-2x6 model still wanted
be5e8963 Vendor TPS2121RUXR 3D model + fix 24-pin U5 footprint nickname
36fed7f7 TODO: mark beta module additions + net sweep done
81b925de Record beta module additions + net-sweep findings (owner-queue + FOLLOWUPS)
26f9ce89 gen-modules: emit the GPIO0 strapping-pin decoupler (C_BOOT + R_BOOT)
beef01f2 24-pin: add comparator bypass caps C73V31/C75VSB1 to the new 3V3/5VSB cells
fd79fe3b All 5 sensing modules: add GPIO0 strapping-pin decoupler (match Hub)
a564cdcd 24-pin: add INA181+TLV7011 fast-detection cells on 3V3 + 5VSB rails
