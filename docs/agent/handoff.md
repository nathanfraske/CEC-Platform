# Agent handoff — 2026-07-27 07:57:04Z
...
HEAD:    fcec6348 followup: edge-clearance root cause is the keepout's connector exclusion windows
...
801a95e8 fab: REPAIR the manufacturability defects, wired into every wave publish
e535de76 fab: check boards against a FAB HOUSE profile, not our own intent
626d6f76 hub: clear the fab DRC gate (0 severity-error) and stop the gate grading blind
b87ef191 fr: snap sub-minimum track widths back onto the floor after SES import
55cb0e26 hub: overnight fab-push chain at high effort
d0840233 queue: the candidate reference is stale because pour quality is not ranked
...
## Broker
{"running": {"cec-worker-quality": {"since": 1785134191, "active": 0, "idle_s": 80}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 104, "starts": 8, "evictions": 0, "by_client": {"CEC-Platform": 104}}}
