# Agent handoff — 2026-06-13 21:52:17Z
...
HEAD:    5859db8 prompt-audit medium fix: slash-tolerant net membership in the T1 unknown-net guard
status:  172 uncommitted path(s)
```
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 1112}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 13, "idle_stop_s": 1800.0, "stats": {"requests": 547, "starts": 5, "evictions": 1, "by_client": {"fs-warm": 98, "CEC-Platform": 404, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 4}}}
