# Agent handoff — 2026-07-02 18:59:37Z
...
HEAD:    25cd7e6 sourcing alternatives survey: PolarFire SoC Core (TC) line = the unlock; PIC64GX fallback
...
95e7b70 survey 10 applied: LAN9370 hub architecture, P4 uniform, RS-485 compat dropped
```

### Working-tree changes
```
 M docs/enterprise-requirements/spec-sheets/hub-ent-spec-sheet.md
```
