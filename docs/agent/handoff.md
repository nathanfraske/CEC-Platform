# Agent handoff — 2026-07-08 06:38:28Z
...
HEAD:    8dc7b67 placer: anchor-vs-anchor collision fix -- the rail row clamps clear of edge connectors (fix A)
...
ab6f727 pours: same-layer cross-net overlap clip (zones_intersect fix, round 2)
```
