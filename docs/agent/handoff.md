# Agent handoff — 2026-07-16 20:36:29Z
...
HEAD:    670702e4 ENT hub: verify + finalize sheet 03 (compute-rails), extend MCP wishlist
status:  37 uncommitted path(s)
```

### Recent commits
```
670702e4 ENT hub: verify + finalize sheet 03 (compute-rails), extend MCP wishlist
9d87e16b memory: outage-recovery handoff note
d436d03c WIP CHECKPOINT (unverified): capture agent's in-flight sheet-03 work — preserved across the 2026-07-16 Sonnet outage
84204a59 ENT hub: capture sheet 04 (storage) — QSPI NOR + generic eMMC 5.1 + straps
48a7e83f ent-kvm-carrier: assign real footprints for 6 of 9 local placeholder parts
ea36d238 ENT eMMC storage: propose FORESEE FEMDNN family, second-source Micron
9b7a19f5 design sheets: Standard tier + Pro/Max tier (rules + cited best practices) — 4-sheet family complete
887ba38d ENT library intake: FTSH-105 JTAG header, TPS7A20/TLV758 LDOs, TLP172A, LM393DR2G, ABM3 crystal, REF3033
172498d3 ENT design sheet: exhaustive placement/routing/rules spec for the pipeline (+ cited best practices)
d35db33f ENT net-lib: JXD1-0001NL (tab-up, owner UL export + mfr STEP) supersedes JXD0
977a78dc ENT net-lib intake: LAN9370-I/KCX + JXD0-0001NL MagJack vendored (owner-supplied CAD)
74d090cb followups: ENT library-intake leftover list + stale hub-ent README flag
```

### Working-tree changes
```
 M FOLLOWUPS.md
 M hubs/hub-enterprise/01-power-input.kicad_sch
 M hubs/hub-enterprise/01a-efuse-main.kicad_sch
 M hubs/hub-enterprise/01b-efuse-5vsb.kicad_sch
 M hubs/hub-enterprise/01c-efuse-ext.kicad_sch
 M hubs/hub-enterprise/01d-cascade.kicad_sch
 M hubs/hub-enterprise/01e-holdup.kicad_sch
 M hubs/hub-enterprise/01f-buck-3v3.kicad_sch
 M hubs/hub-enterprise/01g-rail-sense.kicad_sch
 M hubs/hub-enterprise/02-compute-core.kicad_sch
 M hubs/hub-enterprise/03-compute-rails.kicad_sch
 M hubs/hub-enterprise/03a-core-buck.kicad_sch
 M hubs/hub-enterprise/03b-bank-rails.kicad_sch
 M hubs/hub-enterprise/03c-vdda-ldo.kicad_sch
 M hubs/hub-enterprise/03d-sequencing.kicad_sch
 M hubs/hub-enterprise/04-storage.kicad_sch
 M hubs/hub-enterprise/04a-qspi-nor.kicad_sch
 M hubs/hub-enterprise/04b-emmc.kicad_sch
 M hubs/hub-enterprise/04c-straps.kicad_sch
 M hubs/hub-enterprise/05-module-ports.kicad_sch
 M hubs/hub-enterprise/05a-port1.kicad_sch
 M hubs/hub-enterprise/05a-port2.kicad_sch
 M hubs/hub-enterprise/05a-port3.kicad_sch
 M hubs/hub-enterprise/05a-port4.kicad_sch
 M hubs/hub-enterprise/05a-port5.kicad_sch
 M hubs/hub-enterprise/05a-port6.kicad_sch
 M hubs/hub-enterprise/05a-port7.kicad_sch
 M hubs/hub-enterprise/05a-port8.kicad_sch
 M hubs/hub-enterprise/05b-can-frontend.kicad_sch
 M hubs/hub-enterprise/05c-detect-adc.kicad_sch
 M hubs/hub-enterprise/06-t1-dataplane.kicad_sch
 M hubs/hub-enterprise/07-uplink.kicad_sch
 M hubs/hub-enterprise/08-secio-aux.kicad_sch
 M hubs/hub-enterprise/09-watchdog.kicad_sch
 M hubs/hub-enterprise/gen_hub_enterprise.py
 M hubs/hub-enterprise/hub-enterprise.kicad_sch
?? hubs/hub-enterprise/02a-mpfs-core.kicad_sch
```
