# Agent handoff — 2026-07-16 22:31:28Z
...
HEAD:    2118236e docs: three-load-path schematic SVG (bank leg / vernier loop / SCP crowbar + de-gate rail + star ground)
...
```
 M lib/vendor/cec-power.kicad_sym
?? lib/3dmodels/cec-tester.3dshapes/
?? lib/cec-tester.kicad_sym
?? lib/cec-tester.pretty/
?? lib/datasheets/AOD4184A_C99124.pdf
?? lib/datasheets/CH224K.pdf
?? lib/datasheets/IRLB3034-UMW_C19100597.pdf
?? lib/datasheets/OPA2277UA-2K5.pdf
?? lib/datasheets/SMCJ15A-13-F_C135138.pdf
?? lib/datasheets/TPS54331DR_C9865.pdf
?? testers/tester-standard/fp-lib-table
?? testers/tester-standard/pin-audit-review-2026-07-16.txt
?? testers/tester-standard/sym-lib-table
?? testers/tester-standard/tester-standard.kicad_pro
```
