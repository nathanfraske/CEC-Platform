# Agent handoff — 2026-07-22 23:25:32Z
...
HEAD:    4c1f721f mezz structural-segments study (owner riff) + prop-wave readout bookkeeping
...
23a47b0b placer: p11 fiducial openness sees anchors; 24-pin BL mount to the measured (5,30) courtyard sliver
d6c2b6e2 placer: pinned-rot macro truth + anchor-aware p9 settle -- the every-hub-variant J6 refusal class
```
...
## Broker
{"running": {"cec-worker-quality": {"since": 1784762328, "active": 0, "idle_s": 365}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 49, "starts": 24, "evictions": 0, "by_client": {"CEC-Platform": 49}}}
