# Agent handoff — 2026-07-17 02:37:11Z
...
HEAD:    c85a31b5 tester ST README: ladder operating model + duplicate-1x-group rationale recorded (owner Q&A — doors-not-dimmers, additive-path stepping, LSB fuse tolerance, wear sharing)
...
3e3a2a2d tester ST Phase B: sheets 01-link + 02-power (RJ-45/mis-plug link + USB-C PD power), gen_tester_st.py generator + a diode-OR polarity fix
```
