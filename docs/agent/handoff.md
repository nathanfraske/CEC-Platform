# Agent handoff — 2026-07-23 14:58:24Z
...
HEAD:    12bb8a6e hub In2 rung: one inner GND + In2 signal/pour layer, pickup-guard root cause fixed
...
```
 ...
 M TODO.md
 M scripts/cec_fr.py
 M tests/test_hub_in2_pours.py
```

## Broker
{"running": {}, "gpu_budget_gb": 30.0, "gpu_used_gb": 0, "idle_stop_s": 1800.0, "stats": {"requests": 71, "starts": 31, "evictions": 0, "by_client": {"CEC-Platform": 71}}}
