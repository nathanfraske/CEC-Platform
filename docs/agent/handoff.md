# Agent handoff — 2026-07-25 01:40:29Z
...
HEAD:    9b515c8d pre-FR pour-corridor reservation (CEC_POUR_RESERVE): the pour routes first
status:  0 uncommitted path(s)
```

### Recent commits
```
9b515c8d pre-FR pour-corridor reservation (CEC_POUR_RESERVE): the pour routes first
47da2ec3 design v3.1: connector manifolds + width-margin attach rule (owner algorithm)
dccd4a98 Smoke Tester instant-on: harvest-direct diode-OR bypass (owner first-use-UX ruling follow-through)
...
## Broker
{"running": {"cec-worker-quality": {"since": 1784940867, "active": 0, "idle_s": 566}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 133, "starts": 45, "evictions": 0, "by_client": {"CEC-Platform": 133}}}
