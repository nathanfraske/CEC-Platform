# Agent handoff — 2026-07-08 21:50:51Z
...
HEAD:    4e6e971 checklist: SPICE analog-cell leg (sec6.13 trip vs analytic, 4 rails, ngspice-gated)
status:  20 uncommitted path(s)
```

### Recent commits
```
4e6e971 checklist: SPICE analog-cell leg (sec6.13 trip vs analytic, 4 rails, ngspice-gated)
...
## Broker
{"running": {"cec-worker-quality": {"since": 1783546472, "active": 0, "idle_s": 963}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 3089, "starts": 101, "evictions": 65, "by_client": {"fs-warm": 250, "CEC-Platform": 2626, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3, "cec-inventory-extractor": 7, "cec-inventory-keepwarm": 1}}}
