# Agent handoff — 2026-06-13 17:48:22Z
...
HEAD:    bb0f4bd loop: revive item4 corridor-avoid lever + gate vision to finalists + EI-01 knowledge pin
status:  159 uncommitted path(s)
```
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 6721}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 13, "idle_stop_s": 1800.0, "stats": {"requests": 497, "starts": 3, "evictions": 0, "by_client": {"fs-warm": 91, "CEC-Platform": 365, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1}}}
