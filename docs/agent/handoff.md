# Agent handoff — 2026-07-01 01:32:35Z
...
?? .claude/memory/cec-thermal2d-field-solver.md
?? .claude/memory/convergence-blocker-mechanism-not-corpus.md
?? .claude/memory/dashboard-fixed-port.md
?? .claude/memory/ina238-lo-tap-refusal-blocker.md
?? .claude/memory/kicad-integration-landscape.md
?? .claude/memory/lesson-ablation-before-narrative.md
?? .claude/memory/sudo-docker-access.md
?? .claude/memory/thermal-gate-required.md
?? .claude/memory/v4-seat.md
?? cec_thermal_mgcg_bench.py
?? docs/enterprise-workstation-trust-addendum-2026-06-30.md
?? ops/README-claude-rc.md
?? ops/claude-rc-tmux.sh
?? ops/claude-rc@.service
?? ops/claude-session.sh
?? ops/rc-recover.sh
?? scripts/cec_gmg_bench.py
```

## Broker
{"running": {}, "gpu_budget_gb": 30.0, "gpu_used_gb": 0, "idle_stop_s": 1800.0, "stats": {"requests": 2998, "starts": 83, "evictions": 60, "by_client": {"fs-warm": 250, "CEC-Platform": 2619, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3, "cec-inventory-extractor": 7, "cec-inventory-keepwarm": 1}}}
