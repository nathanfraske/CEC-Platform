# Agent handoff — 2026-06-13 20:16:11Z
...
HEAD:    98efdfb tiers: raise token + timeout ceilings so no seat is cut off mid-thought (owner directive)
status:  163 uncommitted path(s)
```
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 1, "idle_s": 1470}, "cec-manager-fast": {"since": 1781380098, "active": 0, "idle_s": 1618}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 21, "idle_stop_s": 1800.0, "stats": {"requests": 546, "starts": 5, "evictions": 1, "by_client": {"fs-warm": 98, "CEC-Platform": 404, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 3}}}
