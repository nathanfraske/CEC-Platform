# Agent handoff — 2026-07-15 21:58:14Z
...
HEAD:    9fa5009 supercap queue row refined: Pro/Max = no-IC passive shape (owner steering); manager = ENT only
...
8de48bd FOLLOWUPS: tolerance doctrine + margin sweep round 2
