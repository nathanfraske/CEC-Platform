# Agent handoff — 2026-07-27 01:54:15Z
...
HEAD:    cdea5dfb audit: only call it an incursion where the pour was actually reserved first
status:  5 uncommitted path(s)
```

### Recent commits
```
cdea5dfb audit: only call it an incursion where the pour was actually reserved first
76d94a2e followup: the cable boards' incursion count may be over-reporting
09470ced audit: consolidate a chain's winners into a per-board trend
fd8018f5 scope: decompose the 24-pin incursion into its three real problems
2201b5c8 pours: make the eligibility gate real, and conservative
aaf3ba20 audit: measure via scatter, scoped to poured nets
7e14b5eb pours: prune the barrels a dropped layer orphans
cadb5340 pours: a rail a track carries does not get a plane
0103a93d track: pour-fix validation + the two residual pour items
c72b212d pours: single-owner across solution copper, inner-layer reservation, honest diagonal metric
b4b9c1c2 pcie-3port: diagnose the seat conflict, revert the pin that made it worse
...
## Broker
{"running": {"cec-worker-quality": {"since": 1785108252, "active": 0, "idle_s": 137}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 83, "starts": 7, "evictions": 0, "by_client": {"CEC-Platform": 83}}}
