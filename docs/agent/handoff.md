# Agent handoff — 2026-06-16 22:42:24Z
...
HEAD:    062fc21 docs: mark the prose-ref→apply_placement_move e2e gap closed (96232e0)
...
3e79761 followups: placement needs a ref in proposed_lever.target to move end-to-end
ff299ff actuator: read proposed_lever.{type|action}, not just .lever -- THE inert-lever unblock
ac4a580 todo: Hub validation smoke in progress (both audits' fixes landed, route verified)
9fe57f7 hub-route: fix segfault -- isolate the placement-only strip in a subprocess
1ab474a actuation-lever: close the 2nd-audit findings (wf_24ad4f0c-092)
5ab059a actuation-lever: steps 2-4 -- cross-run tally, graduation bar, steer-only chokepoint
0e38d35 actuation-lever: fix the Step-1 firewall per the adversarial audit (wf_f24bddf7-9fd)
```
...
```
 ...
 M scripts/cec_fullstack.py
 M tests/test_prompt_audit_fixes.py
...
?? docs/fullstack-run-2026-06-16-epsinject/
?? docs/fullstack-run-2026-06-16-epsinject2/
?? docs/fullstack-run-2026-06-16/
```

## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 1385}, "cec-worker-vision": {"since": 1781649459, "active": 0, "idle_s": 82}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 23, "idle_stop_s": 1800.0, "stats": {"requests": 1344, "starts": 25, "evictions": 13, "by_client": {"fs-warm": 248, "CEC-Platform": 977, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3}}}
