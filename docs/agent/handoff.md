# Agent handoff — 2026-07-15 20:52:48Z
...
HEAD:    f8cd946 hub-rev2: power-entry TVS + DETECT immunity filters + D-11 DRU ruling
status:  4 uncommitted path(s)
```

### Recent commits
```
f8cd946 hub-rev2: power-entry TVS + DETECT immunity filters + D-11 DRU ruling
ae4ee65 cec_spice_sanity: whole-board DC electrical sanity harness (ngspice)
89f12cf logo = hard keepout for placement AND routing (owner directive)
...
## Broker
{"running": {}, "gpu_budget_gb": 30.0, "gpu_used_gb": 0, "idle_stop_s": 1800.0, "stats": {"requests": 76, "starts": 11, "evictions": 6, "by_client": {"CEC-Platform": 10}}}
