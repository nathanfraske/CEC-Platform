# Agent handoff — 2026-07-17 20:39:18Z
...
HEAD:    1e2726b3 BOM outputs: hub-standard-rev2 + atx-24pin-rev3 generated, PCIe shunt rows enriched, rev3 LCSC propagation
status:  2 uncommitted path(s)
```

### Recent commits
```
1e2726b3 BOM outputs: hub-standard-rev2 + atx-24pin-rev3 generated, PCIe shunt rows enriched, rev3 LCSC propagation
15f69ca2 placer: CAN seat legality vs fixed anchors — fixes the corridor-model CI red
