# Agent handoff — 2026-06-17 02:27:39Z
...
HEAD:    45c7ce6 followups: deterministic placer PROVEN insufficient (fresh route: kelvin fail + 62 clips); LLM-guided placement is the path
status:  49 uncommitted path(s)
```
...
a65a44a followups: close-the-loop keepout characterization + the two paths (A placer / B inner-layer)
180baeb todo: close-loop P0/P1 done + the keystone-placement coupling finding; P5 is the coupled half
91b7d68 close-loop P0/P1: shared corridor_keepouts + the block_fills pour-unblock fix; keystone is placement-coupled
f3f384b docs: EPS placement-lever validation (option 1 DONE) — baseline 0.0 → with-fix 0.667
7b10fed actuation-lever: surface the body-in-corridor fact to the finder -- the lever now FIRES on EPS
062fc21 docs: mark the prose-ref→apply_placement_move e2e gap closed (96232e0)
96232e0 test: prove the prose-resolved ref moves a body end-to-end (closes the wf_6653dbfc seam)
8a30ed8 docs: scope the corridor-gated placement actuator + record the owner decision
f8ddbd9 actuation-lever: harden prose-ref + close the r3 lever-misclassification (review wf_6653dbfc)
fad6bdd actuation-lever: resolve placement target from prose -- the "placement never MOVES" unblock
```
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 14901}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 13, "idle_stop_s": 1800.0, "stats": {"requests": 1350, "starts": 26, "evictions": 14, "by_client": {"fs-warm": 250, "CEC-Platform": 981, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3}}}
