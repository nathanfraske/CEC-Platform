# Agent handoff — 2026-06-26 03:43:34Z
...
## Repo state
```
branch:  claude/sch-tooling-unify
HEAD:    71e5ebb followups: schematic-tooling notes (venv provisioning, overlap residual, verify hardening, IPC refill)
...
## Broker
{"running": {"deepseek-v4-flash": {"since": 1781365566, "active": 0, "idle_s": 797055}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 13, "idle_stop_s": 1800.0, "stats": {"requests": 2987, "starts": 79, "evictions": 59, "by_client": {"fs-warm": 250, "CEC-Platform": 2617, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3}}}
