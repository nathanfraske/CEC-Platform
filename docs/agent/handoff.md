# Agent handoff — 2026-06-13 04:51:32Z
...
HEAD:    b1c0b1c dashboard: real per-seat streaming — record every manager/panel/worker/reviewer
status:  152 uncommitted path(s)
```

### Recent commits
```
b1c0b1c dashboard: real per-seat streaming — record every manager/panel/worker/reviewer
...
## Broker
{"running": {"cec-worker-vision": {"since": 1781325690, "active": 0, "idle_s": 601}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 25, "idle_stop_s": 1800.0, "stats": {"requests": 1, "starts": 1, "evictions": 0, "by_client": {"CEC-Platform": 1}}}
