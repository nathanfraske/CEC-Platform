# Agent handoff — 2026-07-25 22:54:40Z
...
HEAD:    e35db133 measure the no-incursion rule against the pours that are actually laid
status:  5 uncommitted path(s)
```

### Recent commits
```
e35db133 measure the no-incursion rule against the pours that are actually laid
a088a136 pour clip: subtract holes too -- the chained clip was scrapping every force pour
...
## Broker
{"running": {"cec-worker-quality": {"since": 1785018529, "active": 0, "idle_s": 146}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 16, "starts": 3, "evictions": 0, "by_client": {"CEC-Platform": 16}}}
