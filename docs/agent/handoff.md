# Agent handoff — 2026-07-08 21:47:19Z
...
HEAD:    f23b6d7 placer: VECTORIZED legalize_pack landed (12.3x hot loop, output-identical, post-wave-13)
status:  20 uncommitted path(s)
```

### Recent commits
```
f23b6d7 placer: VECTORIZED legalize_pack landed (12.3x hot loop, output-identical, post-wave-13)
a28e98c pour lever: SCOPING plan of record (opus agent, DRAFT awaiting owner review)
83c1865 porting MEASURED (legalize 12.3x identical-output) + co-coordinating router PROTOTYPE (GPU 8.1x)
fe4dc55 oracle: post-freeze wiring batch -- GND-fanout in the route recipe + SI advisories in the verdict
5d254d1 roadmap: SPICE pilot landed + the placer-port profile verdict (Rust/CUDA scoping)
06bab3d SPICE solver LANDED (owner GO): ngspice schematic-cell verification, sec6.13 pilot
...
?? ops/rc-recover.sh
?? routed-drc.json
?? scripts/cec_coord_router.py
?? scripts/cec_gmg_bench.py
```

## Broker
{"running": {"cec-worker-quality": {"since": 1783546472, "active": 0, "idle_s": 751}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 3089, "starts": 101, "evictions": 65, "by_client": {"fs-warm": 250, "CEC-Platform": 2626, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3, "cec-inventory-extractor": 7, "cec-inventory-keepwarm": 1}}}
