# Agent handoff — 2026-07-07 21:30:54Z
...
HEAD:    b5ad472 tests: re-baseline against the beta boards (legacy eps fixture + honest expectation updates)
...
```
 ...
 M tests/test_cl25_checks.py
 M tests/test_ei01_lever_vision.py
 M tests/test_fs_actuator.py
 M tests/test_pcb_reconcile.py
 M tests/test_route_oracle.py
