# Agent handoff — 2026-07-27 03:04:57Z
...
HEAD:    fc7359ea trend: stop silently dropping rows (pour_over label + truncated names)
status:  5 uncommitted path(s)
```

### Recent commits
```
fc7359ea trend: stop silently dropping rows (pour_over label + truncated names)
47611179 followup: via-scatter cannot separate an orphan from a track-to-pour stitch
...
## Broker
{"running": {"cec-worker-quality": {"since": 1785108252, "active": 0, "idle_s": 205}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 19, "idle_stop_s": 1800.0, "stats": {"requests": 92, "starts": 7, "evictions": 0, "by_client": {"CEC-Platform": 92}}}
