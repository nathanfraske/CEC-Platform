# Agent handoff — 2026-07-08 21:00:11Z
...
HEAD:    9218129 SI cheap wins (cec_impedance) + the STANDING solver roadmap doc (owner ask)
status:  19 uncommitted path(s)
```

### Recent commits
```
9218129 SI cheap wins (cec_impedance) + the STANDING solver roadmap doc (owner ask)
1be4259 meta: gnd-fanout wiring + solver-roadmap followups
31583c6 gnd-fanout: per-GND-pin via synthesizer, IMPEDANCE-REDUCING ONLY (owner rule, teeth)
...
?? .claude/memory/pipeline-solver-roadmap.md
...
## Broker
{"running": {"cec-manager-fast": {"since": 1783542738, "active": 0, "idle_s": 1476}, "cec-worker-quality": {"since": 1783543099, "active": 0, "idle_s": 286}}, "gpu_budget_gb": 30.0, "gpu_used_gb": 27, "idle_stop_s": 1800.0, "stats": {"requests": 3088, "starts": 100, "evictions": 65, "by_client": {"fs-warm": 250, "CEC-Platform": 2625, "vlm-bakeoff": 38, "probe": 1, "capstone-smoke": 1, "v4-task": 5, "seat-bakeoff": 70, "seat-bakeoff-probe": 3, "cec-inventory-extractor": 7, "cec-inventory-keepwarm": 1}}}
