...
them) + a dedicated p8 final settle for boxed offenders (loud residual print). The former
4mm connector-manifold allowance was retired after it produced visually and electrically
spurious slabs across interleaved connector pins; manifolds now use a 0.3mm local attach
allowance and the over-under solver owns all remote corridor width. (3) the POURFIRST artifact (anchor
