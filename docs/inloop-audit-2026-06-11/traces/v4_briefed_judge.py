...
CONTEXT = open("/tmp/v4_briefing_context.txt").read()

RAW = """You are reviewing two autorouted candidates of the same PCB. You are given the platform's ratified design documentation and rule corpus, followed by the raw comparison data. Draw your own conclusions.

================ DESIGN DOCUMENTATION & RATIFIED RULE CORPUS ================
""" + CONTEXT + """
================ RAW COMPARISON DATA ================
...
QUESTIONS:
1. Which arm is the better engineering result, and why? Argue from the data AND the rule corpus.
2. What stands out in this data that the headline metrics (drc count, length, objective) do not capture? Cite any corpus rules that apply.
...
judge(RAW, "v4-briefed-judge", max_tokens=6400)
