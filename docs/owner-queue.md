...
| **Merge PR #38 BEFORE/WITH #40** (the CL-21 dive) | so the 5 staged CL-21 corpus entries' dive-refs + the ruling-doc dive-refs resolve in-tree | PR #38, branch `claude/research-cl21-vlm-seat` |
