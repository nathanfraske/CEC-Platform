...
- STATUS: effector-map+design workflow `wf_66c88f2d-f92` running; then implement wiring + control arm +
  promotion settlement, run a shakeout loop to demonstrate a finding gated against a control + reach DRC=0.
