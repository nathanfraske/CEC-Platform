...
- **Flat-tab rework LANDED (2026-07-05 ~21:45)**: daughterboard tab = TE 63951-1 (.250×.032 FASTON, 90° mount → in-plane blade, vertical drop into 3586 clip top entry; LCSC C591344, stock 4,345, $0.099-0.164; legs/holes identical to retired 63849-1). 3 boards regenerated (sizes unchanged), coordinator-verified ERC 0 / DRC 0/0 / keying proof / net maps. OWNER fit-check addition: ~0.27mm blade-hang(6.89) vs clip-body(7.16) shortfall at zero standoff — owner-queue (a). Spec/CLAUDE.md MPN sync in FOLLOWUPS pending owner confirm. 63849-1 "$0.04" was stale ($0.0795@100 live).
