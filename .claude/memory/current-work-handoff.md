...
_Updated 2026-06-20 (12VHPWR THERMAL pushback RESOLVED — owner challenged the 149C/dT99 dashboard number as too hot vs his prior ~14C calc; audited the solver end-to-end and it's SOUND, the 99C was a no-cooling boundary condition. With his production cooling modeled it's dT 24C = PASS. New solver hook `chassis_refs`/`g_chassis_W_per_K`.)._
