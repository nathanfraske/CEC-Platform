...
- BUILD PROGRESS (this session, PR #60):
  ...
  * RE-SMOKE running (docs/fullstack-run-2026-06-15-hubsmoke2) to confirm levers engage LIVE.
  * REMAINING (FOLLOWUPS): for placement to MOVE, the finding must name a ref in proposed_lever.target
    (Hub r3 had none) -- finder-prompt or prose-ref-extraction follow-up. Then the longer Hub validation run.
