...
_Updated 2026-06-24 (12VHPWR thermal INTEGRATION wired into the dashboard + a fine-grained board passover. The 06-20 production-cooling hook is now WIRED into board_thermal_config so the dashboard shows the 12VHPWR board's case-cooled dT 23 = PASS, not the still-air dT 101. A 16-agent passover confirmed the board is fully routed / conformant / fab-ready / thermal-PASS; retired the stale CLAUDE.md action items. Branch claude/placement-corridor, commits bb60c65 / 55be140 / c45c179 — NOT YET PUSHED.)._
