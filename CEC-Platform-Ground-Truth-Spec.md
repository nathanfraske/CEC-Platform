...
### 3.1 CAN: control and low-rate telemetry (LOCKED; classical everywhere, v2.0)
...
- Bench item: star topology with up to 8 stubs at 500k should be signal-integrity verified. The risk is star termination plus stub length.
