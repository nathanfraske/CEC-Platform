...
Sim (CI-able, no vendor tools):
    ...
    # expect: PASS: decimator average, LIVE seq, BURST ring, STREAM dropcount, STATUS rate counter, NATIVE-ANOMALY ...
...
`cec_native_anomaly.v`, `cec_native_rail.v`, `../common/cec_spi_slave.v`, and
`12vhpwr-proto.cst`, synthesize, place-route,
