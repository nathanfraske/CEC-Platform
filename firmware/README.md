...
`cec_native_anomaly.v`, `../common/cec_spi_slave.v`, and `12vhpwr-proto.cst`,
  ...
  rtl-sim:
    ...
    steps:
      ...
      - run: |
          ...
          iverilog -g2012 -o tb tb_top.v top.v cec_boxcar_decim.v cec_native_anomaly.v ../common/cec_spi_slave.v
          vvp tb | tee sim.log
          grep -q '^PASS' sim.log
  esp-build:
    runs-on: ubuntu-latest
