...
Plug-in daughterboard on the keyed 2×10 socket pair (J_BRICK). Carries EVERY part that
...
where the 22 V MOV conducts and the GDT takes ≥~90 V/mains) · 8× **2R090T GDT** (◆ the
...
1× **KNP-class 33 Ω 2 W** harvest fusible.
